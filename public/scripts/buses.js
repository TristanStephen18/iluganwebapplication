      ...
      querysnapshot.docs.forEach((doc) => {
        ...
        const busesrow = `
          <tr data-bus-number="${doc.id}">
            <td style = "font-weight: bold;"><img src ="../images/bicon2.png" style = "width: 75px; height: 50px; margin-bottom: 4px;"></img><br>${
              doc.id
            }</td>
      ...
      snapshot.docs.forEach((doc) => {
        ...
        if (data.inbus == '' && data.type == "conductor") {
          ...
          conductorContainer.innerHTML = `
            <img src = "../images/conicon.png" alt = "conductorimage" id = "conimage">
            <p>${data.id}</p>
